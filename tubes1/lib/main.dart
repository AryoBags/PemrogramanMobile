...
import 'package:tubes1/screens/create_screen.dart';
import 'package:tubes1/screens/update_screen.dart';
import 'package:tubes1/db/database_instace.dart';
import 'package:tubes1/models/transaksi_model.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  showAlertDialog(BuildContext context, int idTransaksi) {
    ...
    AlertDialog alertDialog = AlertDialog(
      ...
      content: Text("Anada yakin akan mengapus ?"),
      actions: [okButton],
    );
    showDialog(
        context: context,
